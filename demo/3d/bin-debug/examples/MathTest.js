        ...
        PlaneIntersectsSphere.prototype.onAwake = function () {
            {
                ...
                material.setCullFace(false).setDepth(true, false).setBlend(1 /* Blend */).setRenderQueue(3000 /* Transparent */).setOpacity(0.7);
                this._planeObject.renderer.material = material;
            }
            {
                var material = egret3d.Material.create(egret3d.DefaultShaders.MATERIAL_COLOR);
                material.setDepth(true, true).setBlend(1 /* Blend */).setRenderQueue(3000 /* Transparent */).setOpacity(0.7);
