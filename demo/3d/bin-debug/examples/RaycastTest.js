    ...
    var RaycastTest = (function () {
        ...
        RaycastTest.prototype.start = function () {
            return __awaiter(this, void 0, void 0, function () {
                var gameObject, light, gameObject, line, gameObject, boxCollider, boxCollider, sphereCollider, line;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            {
                                gameObject = egret3d.DefaultMeshes.createObject(egret3d.DefaultMeshes.CYLINDER, "Mesh");
                                gameObject.transform.setLocalPosition(0.0, 0.0, 0.0);
                                gameObject.renderer.material = egret3d.DefaultMaterials.MESH_LAMBERT;
                                line = paper.GameObject.create("RaycastTester");
                            ...
                            {
                                gameObject = egret3d.DefaultMeshes.createObject(egret3d.DefaultMeshes.PYRAMID, "BoxCollider");
