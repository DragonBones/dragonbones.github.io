...
(function (examples) {
    ...
    var Updater = (function (_super) {
        ...
        Updater.prototype.onUpdate = function () {
            ...
            for (var _i = 0, _a = inputCollecter.downPointers; _i < _a.length; _i++) {
                var pointer = _a[_i];
            ...
            for (var _b = 0, _c = inputCollecter.holdPointers; _b < _c.length; _b++) {
                var pointer = _c[_b];
            ...
            for (var _d = 0, _e = inputCollecter.upPointers; _d < _e.length; _d++) {
                var pointer = _e[_d];
                var cube = this._holdCubes[pointer.event.pointerId];
                if (cube) {
                    cube.destroy();
